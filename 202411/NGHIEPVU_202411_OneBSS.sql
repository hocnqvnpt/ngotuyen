...
delete from SBH_vinagift_202411_CT where mucdich_sd = 'GHTT' ;
commit ;
...
update SBH_vinagift_202411_CT a set a.manv_hrm=(select manv_hrm from ttkd_bsc.nhanvien where ma_nv=upper(manv_cn) and thang=202411)
...
update SBH_vinagift_202411_CT a set (a.ten_nv,a.ma_vtcv,a.ten_vtcv,a.ma_to,a.ten_to,a.ma_pb,a.ten_pb)
                    =(select ten_nv,ma_vtcv,ten_vtcv,ma_to,ten_to,ma_pb,ten_pb 
                      from ttkd_bsc.nhanvien where manv_hrm = a.manv_hrm and thang = 202411) where a.manv_hrm is not null ;
commit ;
...
update SBH_ussd_202411_CT a set (a.ten_nv,a.ma_vtcv,a.ten_vtcv,a.ma_to,a.ten_to,a.ma_pb,a.ten_pb)
                    =(select ten_nv,ma_vtcv,ten_vtcv,ma_to,ten_to,ma_pb,ten_pb 
                      from ttkd_bsc.nhanvien where ma_nv=a.manv_hrm  and thang=202411) where a.manv_hrm is not null ;
commit ;
...
update SBH_CCOS_202411_CT a set (a.manv_hrm,a.ten_nv,a.ma_vtcv,a.ten_vtcv,a.ma_to,a.ten_to,a.ma_pb,a.ten_pb)
                    =(select manv_hrm,ten_nv,ma_vtcv,ten_vtcv,ma_to,ten_to,ma_pb,ten_pb 
                      from ttkd_bsc.nhanvien where user_ccos=a.user_ccos and thang=202411) ;
commit ;
...
with v_db as ( select tt.thanhtoan_id, tt.khachhang_id, kh.ma_kh
                from tinhcuoc.v_dbtt@dataguard tt, tinhcuoc.v_dbkh@dataguard kh
                    ...
                    and tt.ky_cuoc = '20241101' and kh.ky_cuoc = '20241101'
...
-- drop table SBH_VNP_202411_CT purge ;
...
--              (select ma_hd from danhba_dds_112024_temp where somay=a.ma_tb and rownum=1)ma_gd
             db.ma_hd ma_gd
    from SOLIEU_CCBS a 
    left join ttkd_bsc.nhanvien nv on a.user_cn=nv.user_ccbs and nv.thang = 202411
...
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'CNTTTB' and 'CCBS' = loai and a.thang = 202411
						and exists (select * from  tuyenngo.sbh_vnp_202411_ct where ten_loaihd = 'CAP NHAT DB' and ma_tb = a.ma_tb)
			;
