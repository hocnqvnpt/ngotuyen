...
INSERT INTO DIGISHOP (THANG, NGAY_TAO_DON, NGAY_CAP_NHAT, MA_DON_HANG, TRANSID, CDPID, MA_DHSX, DIA_BAN, KENH_BAN, MA_GIOITHIEU, TENNV_GIOITHIEU, DONVI_BH
     ...
     , TOQL_TAOSIM, SDTLH_TAOSIM, DONVI_TAOSIM, TENNV_DK_TTTB, MANV_DK_TTTB, TOQL_DK_TTTB, SDTLH_DK_TTTB, DONVI_DK_TTTB
     )
...
from ttkd_bsc.ct_bsc_ptm where thang_ptm in(202409) ;

select * from ttkd_bsc.ct_bsc_ptm where thang_ptm=202409 and dich_vu='MyTV MOBILE' ;
-- delete from ttkd_bsc.ct_bsc_ptm where thang_ptm=202409 and dich_vu='MyTV MOBILE' ;
commit ;
-- Digishop (MyTV Mobile)
--delete from ct_bsc_ptm where thang_ptm=202409 and dich_vu='MyTV MOBILE';
...
from 
(
    select 202409 thang_luong, 202409 thang_ptm, danhmuc dich_vu
            ...
            , 202409 thang_tldg_dt, 202409 thang_tlkpi, 202409 thang_tlkpi_to, 202409 thang_tlkpi_phong  
    from ttkd_bsc.digishop a, ttkd_bsc.nhanvien b
    
    where a.thang=202409 
    and a.ma_gioithieu=b.ma_nv 
    and b.thang=202409 and b.donvi='TTKD'
    and danhmuc='MyTV MOBILE'
    --and ( upper(bo_dau(danhmuc)) like 'MYTV MOBILE' or upper(bo_dau(danhmuc)) like 'INTERNET%' )
    and dia_ban like 'TP H_ Ch_ Minh' and ma_gioithieu is not null 
...
select DISTINCT DANHMUC from ttkd_bsc.digishop ;
select * from ttkd_bsc.digishop ;
--thang_ptm >= 202401 and ma_tb in('84834753888','84822999590','84828666439','84828500131','84843313338','84852345448','84947681782','84948227801','84949019916')
 ...
 where thang_luong=9 
 and exists(select 1 from ttkd_bsc.digishop where a.ma_tb=ma_dhsx and thang=202409 ) ;
 commit ;
 rollback ;
