...
create index thaydoitocdo_202409_hdtbid on thaydoitocdo_202409 (hdtb_id) ;
create index thaydoitocdo_202409_thuebaoid on thaydoitocdo_202409 (thuebao_id) ;
create index thaydoitocdo_202409_maduan on thaydoitocdo_202409 (ma_duan_banhang) ;
create index thaydoitocdo_202409_matb on thaydoitocdo_202409 (ma_tb) ;

select * from thaydoitocdo_202409 ;

alter table thaydoitocdo_202409 
    add ( tien_dvgt_bs number, 
              ...
              nop_du number);
commit ;
create table thaydoitocdo_202409_goc as select * from thaydoitocdo_202409 ; -- luu bang truoc khi delete
select * from thaydoitocdo_202409_goc;

delete from thaydoitocdo_202409 a
    -- select * from thaydoitocdo_202409 a
...
create table temp_tbduan as 
    select thuebao_id, ma_duan from tuyenngo.v_db_duan a
        where exists(select 1 from thaydoitocdo_202409 where thuebao_id=a.thuebao_id)
            and ma_duan is not null;
create index temp_tbduan on temp_tbduan (thuebao_id);

alter table thaydoitocdo_202409 add ma_duan varchar2(20);
update thaydoitocdo_202409 a 
...
/*
update thaydoitocdo_202409 a set dthu_ps_old='', dthu_ps_new='';
update thaydoitocdo_202409 a 
...
*/
-- dthu_ps_old,dthu_ps_new :
alter table thaydoitocdo_202409 add dthu_ps_old_1 number ;
commit ;

select ma_tb, count(*)sl from thaydoitocdo_202409 group by ma_tb ;
...
update thaydoitocdo_202409 a set dthu_ps_old='', dthu_ps_new='', dthu_ps_old_1='' ;
...
-- Bo sung iptinh
alter table thaydoitocdo_202409 add iptinh number;
...
-- dthu_duoctinh:
update thaydoitocdo_202409 set dthu_duoctinh='';
update thaydoitocdo_202409 
...
update thaydoitocdo_202409 a set lydo_khongtinh_luong='';
update thaydoitocdo_202409 a 
    set lydo_khongtinh_luong=lydo_khongtinh_luong||'-Tinh luong theo hs lap moi'
    -- select lydo_khongtinh_luong from thaydoitocdo_202409 a
...
commit ;
--select a.* from thaydoitocdo_202409 a where exists (select 1 from tuyenngo.cdbr_ptm_202409_bctuan where loaihd_id=1 and thuebao_id=a.thuebao_id) ;

--select distinct dichvuvt_id from thaydoitocdo_202409 ;
...
update thaydoitocdo_202409 a set (pbh_ptm_id,manv_ptm,tennv_ptm,ma_to,ten_to,ma_pb,ten_pb,ma_vtcv,loai_ld,nhom_tiepthi)=
...
insert into ttkd_bsc.ct_bsc_ptm 
        ...
        from tuyenngo.thaydoitocdo_202409_bs a
