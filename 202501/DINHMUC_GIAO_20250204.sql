...
update DINHMUC_GIAO_DTHU_PGDPT a set thang = 2025019999 where thang = 202501 ;
commit ;
...
select * from dinhmuc_giao_dthu_ptm a where thang = 2025019999 ;

insert into dinhmuc_giao_dthu_ptm(THANG, MA_NV, TEN_NV, MA_TO, TEN_TO, TEN_VTCV, MA_VTCV, MA_PB, TEN_PB, BRCD_DTGIAO
                                , MYTV_DTGIAO, VNPTT_DTGIAO, VNPTS_DTGIAO, TSL_DTGIAO, ITT_DTGIAO, CNTT_DTGIAO, NHOMBRCD_DTGIAO
                                , NHOMVINA_DTGIAO, NHOMTSL_DTGIAO, NHOMCNTT_DTGIAO, TONG_DTGIAO, DATEINPUT, DINHMUC_1, DINHMUC_2
                                , DINHMUC_3, KHDK, TLTH, KQTH, HESO_QD_DT_PTM, LOAI_KPI, TT_MANV, NHOMBRCD_KQTH, NHOMVINATS_KQTH
                                , NHOMVINATT_KQTH, NHOMCNTT_KQTH, NHOMCONLAI_KQTH, CANHAN_THUCHIEN, CANHAN_GIAO, TINH_BSC
                                , NHOMVNPQD_KQTH, PGD_MANV, GHICHU, THAYDOI_VTCV) 
select 2025019999, MA_NV, TEN_NV, MA_TO, TEN_TO, TEN_VTCV, MA_VTCV, MA_PB, TEN_PB, BRCD_DTGIAO
                                , MYTV_DTGIAO, VNPTT_DTGIAO, VNPTS_DTGIAO, TSL_DTGIAO, ITT_DTGIAO, CNTT_DTGIAO, NHOMBRCD_DTGIAO
                                , NHOMVINA_DTGIAO, NHOMTSL_DTGIAO, NHOMCNTT_DTGIAO, TONG_DTGIAO, DATEINPUT, DINHMUC_1, DINHMUC_2
                                , DINHMUC_3, KHDK, TLTH, KQTH, HESO_QD_DT_PTM, LOAI_KPI, TT_MANV, NHOMBRCD_KQTH, NHOMVINATS_KQTH
                                , NHOMVINATT_KQTH, NHOMCNTT_KQTH, NHOMCONLAI_KQTH, CANHAN_THUCHIEN, CANHAN_GIAO, TINH_BSC
                                , NHOMVNPQD_KQTH, PGD_MANV, GHICHU, THAYDOI_VTCV
from dinhmuc_giao_dthu_ptm a where thang = 202501 ;
commit ;

update dinhmuc_giao_dthu_ptm a set thang = 2025019999 where thang = 202501 ;
rollback ;

select thang, ma_nv, ten_nv, tong_dtgiao from dinhmuc_giao_dthu_ptm a
where thang = 202501
and exists(select 1 from DINHMUC_GIAO_DTHU_PGDPT where thang = 2025019999 and ma_nv = a.ma_nv) 
;
...
update dinhmuc_giao_dthu_ptm a set KHDK = '' ;
update dinhmuc_giao_dthu_ptm a set KHDK = CANHAN_GIAO
-- select * from dinhmuc_giao_dthu_ptm a
where thang = 202501 and NVL(CANHAN_GIAO,0) > 0 and nvl(KHDK,0) = 0 ;
commit ;
...
/* ------------ UP LAI KHDK = 0 KHI TONG_DTGIAO is null and dinhmuc_1 is not null ----------- */
update dinhmuc_giao_dthu_ptm a set KHDK = TONG_DTGIAO
-- select * from dinhmuc_giao_dthu_ptm
where thang = 202501 and TONG_DTGIAO > 0 and nvl(KHDK,0) = 0 and NVL(CANHAN_GIAO,0) = 0 ; -- and dinhmuc_1 is not null 

commit ;

update dinhmuc_giao_dthu_ptm a set KHDK = 0
-- select * from tuyenngo.dinhmuc_giao_dthu_ptm_202501 
where thang = 202501 and TONG_DTGIAO is null and KHDK is null ; -- and dinhmuc_1 is not null 
commit ;
