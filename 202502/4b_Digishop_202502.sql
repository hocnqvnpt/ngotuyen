  ...
  CREATE TABLE "TTKD_BSC"."DIGISHOP_202502" 
   (	"THANG" CHAR(6 BYTE), 
	"NGAY_TAO_DON" DATE, 
...
from ttkd_bsc.ct_bsc_ptm where thang_ptm in(202502) ;

select * from ttkd_bsc.ct_bsc_ptm where thang_ptm=202502 and dich_vu='MyTV MOBILE' ;
-- delete from ttkd_bsc.ct_bsc_ptm where thang_ptm=202502 and dich_vu='MyTV MOBILE' ;
commit ;
-- Digishop (MyTV Mobile)
--delete from ct_bsc_ptm where thang_ptm=202502 and dich_vu='MyTV MOBILE';
...
from 
(
    select 202502 thang_luong, 202502 thang_ptm, danhmuc dich_vu
            ...
            , 202502 thang_tldg_dt, 202502 thang_tlkpi, 202502 thang_tlkpi_to, 202502 thang_tlkpi_phong  
    from ttkd_bsc.digishop a, ttkd_bsc.nhanvien b    
    where a.thang=202502 
    and a.ma_gioithieu=b.ma_nv 
    and b.thang=202502 and b.donvi='TTKD'
...
select DISTINCT DANHMUC from ttkd_bsc.digishop_202502 ;
