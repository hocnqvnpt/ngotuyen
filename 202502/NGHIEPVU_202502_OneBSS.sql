...
select * from SBH_vinagift_202502_CT where manv_cn in('790627','790272') ;
select distinct manv_cn,nhanvien_cn from SBH_vinagift_202502_CT where manv_hrm is null ;
select * from SBH_vinagift_202502_CT where mucdich_sd = 'GHTT' ;
delete from SBH_vinagift_202502_CT where mucdich_sd = 'GHTT' ;
commit ;

--update SBH_vinagift_202502_CT set manv_hrm=upper(manv_cn) where manv_cn in('CTV053229','ctv041285') ;
--commit ;
update SBH_vinagift_202502_CT set manv_cn=upper(manv_cn) ;

update SBH_vinagift_202502_CT set manv_cn='000'||manv_cn where length(trim(manv_cn))=2 ;
update SBH_vinagift_202502_CT set manv_cn='00'||manv_cn where length(trim(manv_cn))=3 ;
update SBH_vinagift_202502_CT set manv_cn='0'||manv_cn where length(trim(manv_cn))=4 ;

update SBH_vinagift_202502_CT a set a.manv_hrm=(select manv_hrm from ttkd_bsc.nhanvien where ma_nv=upper(manv_cn) and thang=202502)
where a.manv_hrm is null ;

commit ;

update SBH_vinagift_202502_CT a set (a.ten_nv,a.ma_vtcv,a.ten_vtcv,a.ma_to,a.ten_to,a.ma_pb,a.ten_pb)
                    =(select ten_nv,ma_vtcv,ten_vtcv,ma_to,ten_to,ma_pb,ten_pb 
                      from ttkd_bsc.nhanvien where manv_hrm = a.manv_hrm and thang = 202502) where a.manv_hrm is not null ;
commit ;

select distinct manv_cn,nhanvien_cn from SBH_vinagift_202502_CT where manv_hrm is null ;

select * from SBH_vinagift_202502_CT where manv_hrm is null ;
      select so_seri ma_tb,NULL ma_gd, NULL ma_kh,manv_hrm manv_ra_pct,ten_nv tennv_ra_pct,ma_to mato_ra_pct,ten_to tento_ra_pct,ma_pb mapb_ra_pct,ten_pb tenpb_ra_pct,
             ma_vtcv, to_date('01/02/2025 00:00','dd/mm/yyyy hh24:mi')ngay_cn, 0 tg_damthoai, 'VINAGIFT' TEN_LOAIHD,'VINAGIFT' loai 
             from SBH_VINAGIFT_202502_CT 

/* ------------------ UPDATE USSD ------------------- */

/* SMRS vao mail tap doan, VAO  PHAN TICH -> NHOM BAO CAO DOI SIM 4G -> BC CHI TIET DOI SIM 4G - hh24:mi:ss */

select * from SBH_ussd_202502_CT where manv_hrm is null and ccbs_user is not null ;
select * from SBH_ussd_202502_CT 
...
--update SBH_ussd_202502_CT set manv_cn=upper(manv_cn) ;

update SBH_ussd_202502_CT a set a.manv_hrm=ma_ctv where ma_ctv is not null ;
commit ;

update SBH_ussd_202502_CT a set a.manv_hrm=(select ma_nv from ttkd_bsc.nhanvien where thang = 202502 and user_ccbs=a.ccbs_user)
where a.manv_hrm is null ;
commit ;

update SBH_ussd_202502_CT a set (a.ten_nv,a.ma_vtcv,a.ten_vtcv,a.ma_to,a.ten_to,a.ma_pb,a.ten_pb)
                    =(select ten_nv,ma_vtcv,ten_vtcv,ma_to,ten_to,ma_pb,ten_pb 
                      from ttkd_bsc.nhanvien where ma_nv=a.manv_hrm  and thang=202502) where a.manv_hrm is not null ;
commit ;

select distinct ccbs_user from SBH_ussd_202502_CT where manv_hrm is null ;
...
update SBH_ccos_202502_CT set ma_tb='84'||trim(ma_tb);
commit ;

update SBH_CCOS_202502_CT a set (a.manv_hrm,a.ten_nv,a.ma_vtcv,a.ten_vtcv,a.ma_to,a.ten_to,a.ma_pb,a.ten_pb)
                    =(select manv_hrm,ten_nv,ma_vtcv,ten_vtcv,ma_to,ten_to,ma_pb,ten_pb 
                      from ttkd_bsc.nhanvien where user_ccos=a.user_ccos and thang=202502) ;
commit ;

select * from SBH_CCOS_202502_CT where manv_hrm is null ;
      ...
      select ma_tb,NULL ma_gd, NULL ma_kh,manv_hrm manv_ra_pct,ten_nv tennv_ra_pct,ma_to mato_ra_pct,ten_to tento_ra_pct,ma_pb mapb_ra_pct,ten_pb tenpb_ra_pct,
             ...
             from SBH_CCOS_202502_CT 

/* ------------------------------------------------------------------ */

/* NV */
--select * from SBH_202502_CT ;
--drop table SBH_202502_CT ;
...
create table a_sbh_temp as
      ...
      and hdkh.ngay_yc between to_date('01/02/2025 00:01:00','dd/mm/yyyy hh24:mi:ss') and to_date('28/02/2025 23:59:59','dd/mm/yyyy hh24:mi:ss')
      and hdtb.dichvuvt_id <> 2 
;

select * from a_sbh_temp ;
--drop table SBH_202502_CT purge ;
CREATE TABLE SBH_202502_CT AS 
with v_nv as 
    (select ma_nv, ten_nv , ma_vtcv, ten_vtcv, ma_to, ten_to, ma_pb, ten_pb, nhanvien_id
        from ttkd_bsc.nhanvien nv where thang = 202502)
...
(
    select to_char(trunc(a.ngay_tn),'yyyymm') thang, a.donvi_id, a.thuebao_id,            
      ...
      and a.ngay_tn between to_date('01/02/2025 00:01:00','dd/mm/yyyy hh24:mi:ss') and to_date('28/02/2025 23:59:59','dd/mm/yyyy hh24:mi:ss')
      union all
      select to_char(trunc(a.ngay_gq),'yyyymm') thang, a.donvi_id, a.thuebao_id,            
              a.ma_tb,a.loaitb_id,a.dichvuvt_id, a.ngay_tn, a.nguoi_cn, a.nhanvien_id, a.nhanvien_gq_id, 
              'KHIEU NAI - HOAN THANH' TEN_LOAIHD, MA_KN, NGAY_GQ
      from qltn.v_khieunai@dataguard a where phanvung_id=28 and a.dichvuvt_id <> 2 
      and a.ngay_gq between to_date('01/02/2025 00:01:00','dd/mm/yyyy hh24:mi:ss') and to_date('28/02/2025 23:59:59','dd/mm/yyyy hh24:mi:ss')  
) a
left join (select db.khachhang_id, db.thuebao_id from css.v_db_thuebao@dataguard db) db on a.thuebao_id = db.thuebao_id
;

create table SBH_KHIEUNAI_202502_CT_TN AS
with v_nv as 
    (select ma_nv, ten_nv , ma_vtcv, ten_vtcv, ma_to, ten_to, ma_pb, ten_pb, nhanvien_id
        from ttkd_bsc.nhanvien nv where thang = 202502)
select a.*,
...
create table SBH_KHIEUNAI_202502_CT_GQ AS
with v_nv as 
    (select ma_nv, ten_nv , ma_vtcv, ten_vtcv, ma_to, ten_to, ma_pb, ten_pb, nhanvien_id
        from ttkd_bsc.nhanvien nv where thang = 202502)
select a.*,
...
with v_db as ( select tt.thanhtoan_id, tt.khachhang_id, kh.ma_kh
                from tinhcuoc.v_dbtt@dataguard tt, tinhcuoc.v_dbkh@dataguard kh
                    ...
                    and tt.ky_cuoc = '20250201' and kh.ky_cuoc = '20250201'
...
from 
     ( 
       ...
       Where a.phieu_id=b.phieu_id 
         and b.dichvuvt_Id <> 2 
         and a.ky_cuoc='20250101' and b.ky_cuoc='20250101'
         and a.ngay_cn between to_date('01/02/2025 00:01:00','dd/mm/yyyy hh24:mi:ss') 
                           and to_date('28/02/2025 23:59:59','dd/mm/yyyy hh24:mi:ss')
     ) a, v_db db
where  a.thanhtoan_id = db.thanhtoan_id(+)
--and a.dichvuvt_id = db.dichvuvt_id(+)
;

drop table SBH_CT_THU_202502_CT purge ;
create table SBH_CT_THU_202502_CT as 
with v_nv as 
    (select ma_nv, ten_nv , ma_vtcv, ten_vtcv, ma_to, ten_to, ma_pb, ten_pb, nhanvien_id
        from ttkd_bsc.nhanvien nv where thang = 202502)
...
;
create index SBH_CT_THU_202502_CT_matb on SBH_CT_THU_202502_CT(ma_tb) ;
select * from SBH_CT_THU_202502_CT ;
/* ---------------------- VNP ----------------------- */
drop table SOLIEU_CCBS purge ;
create table SOLIEU_CCBS as 
select distinct a.* from ccs_hcm.SOLIEU_CCBS_20250228@ttkddbbk2 a 
--  where ngay_cn between to_date('01/02/2025 00:01:00','dd/mm/yyyy hh24:mi:ss') and to_date('28/02/2025 23:59:59','dd/mm/yyyy hh24:mi:ss')
;
...
select somay, ma_hd, ma_kh, doituong_id from ccs_hcm.danhba_dds_022025@ttkddbbk2 ;
create index danhba_dds_temp_somay on danhba_dds_temp (somay) ;

-- drop table SBH_VNP_202502_CT purge ;
CREATE TABLE "TUYENNGO"."SBH_VNP_202502_CT" 
   (	
...
;
select distinct TEN_LOAIHD from SBH_VNP_202502_CT ;
truncate table SBH_VNP_202502_CT ;
insert into SBH_VNP_202502_CT(MA_GD, MA_KH, MA_TB, MST, LOAI_TB, MANV_RA_PCT, TENNV_RA_PCT, MA_VTCV, TEN_VTCV, MATO_RA_PCT, TENTO_RA_PCT
...
(
    select  ( case when a.ma_kh is not null then cast(a.ma_kh as varchar(20))
            ...
            ,( case when substr(a.user_cn,1,2) like 'dl%' then (select buucuc from nhuy.userld_202502_goc where user_ld=a.user_cn) 
...
--            ,db.ma_hd ma_gd
            , db.doituong_id
    from SOLIEU_CCBS a 
    left join ttkd_bsc.nhanvien nv on a.user_cn=nv.user_ccbs and nv.thang = 202502
    left join tuyenngo.danhba_dds_temp db on db.somay=a.ma_tb and rownum=1
) a
left join ccs_hcm.khachhangs_022025@ttkddbbk2 kh on a.ma_kh = kh.ma_kh
;
commit ;
update SBH_VNP_202502_CT a set loaihd_id = (select distinct loaihd_id from SBH_VNP_202412_CT where ten_loaihd = a.ten_loaihd) ;
commit ;

select distinct ma_gd, loaihd_id , ten_loaihd from SBH_VNP_202502_CT 
where ten_loaihd in('HMM TRA SAU','CHUYEN QUYEN') ;

alter table SBH_VNP_202502_CT add magd varchar2(20) ;
update SBH_VNP_202502_CT a set magd = ma_gd 
...
select magd, ten_loaihd from SBH_VNP_202502_CT 
where ten_loaihd in('HMM TRA SAU','CHUYEN QUYEN') ;
select * -- distinct tennv_ra_pct
from SBH_VNP_202502_CT 
...
select *  delete from ttkd_bsc.ct_bsc_nghiepvu where thang = 202502;
...
insert into ttkd_bsc.ct_bsc_nghiepvu (THANG, MA_TB, NGAY_DKY_VI, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, ten_vtcv, MA_VTCV, MA_TO, MA_PB, LOAI, TEN_LOAIHD)
			...
			where ngay_dky_vi between to_date('01/02/2025 00:00:01','dd/mm/yyyy hh24:mi:ss') and to_date('28/02/2025 23:59:59','dd/mm/yyyy hh24:mi:ss') 
...
insert into ttkd_bsc.ct_bsc_nghiepvu (THANG, MA_TB, NGAY_DKY_VI, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB, LOAI, TEN_LOAIHD)
		...
		from ttkdhcm_ktnv.hcm_vmoney_ketqua a
					join ttkd_bsc.nhanvien nv on nv.donvi = 'TTKD' and a.ma_hrm = nv.ma_nv and nv.thang = a.thang
		where ngay_dky_mm between to_date('01/02/2025 00:00:01','dd/mm/yyyy hh24:mi:ss') and to_date('28/02/2025 23:59:59','dd/mm/yyyy hh24:mi:ss') 
...
insert into ttkd_bsc.ct_bsc_nghiepvu (THANG, MA_TB, NGAY_DKY_VI, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB, LOAI, TEN_LOAIHD)
		...
		from ttkdhcm_ktnv.HCM_VNPTAPP_ACTIVE a
					join ttkd_bsc.nhanvien nv on nv.donvi = 'TTKD' and a.ma_hrm = nv.ma_nv and nv.thang = a.thang
		where ngay_active between to_date('01/02/2025 00:00:01','dd/mm/yyyy hh24:mi:ss') and to_date('28/02/2025 23:59:59','dd/mm/yyyy hh24:mi:ss')
;
commit ;
/*----HauMai-Muc 4-----CCOS - KHIEU NAI - TIEPNHAN--------*/
	...
	insert into ttkd_bsc.ct_bsc_nghiepvu (thang, MA_PA, MA_TB, NGHIEPVU, USER_CCOS, TEN_LOAIHD, LOAI, NGAY_DKY_VI, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB)
				...
				from tuyenngo.SBH_CCOS_202502_CT a
							join ttkd_bsc.nhanvien nv on nv.donvi = 'TTKD' and a.USER_CCOS = nv.user_ccos and nv.thang = 202502
...
insert into ttkd_bsc.ct_bsc_nghiepvu (MA_TB, NGHIEPVU, NGAY_DKY_VI, TEN_LOAIHD, LOAI, THANG, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, ten_vtcv, MA_VTCV, MA_TO, MA_PB)
			...
			from tuyenngo.SBH_ussd_202502_CT a
						join ttkd_bsc.nhanvien nv on nv.donvi = 'TTKD' and  a.MANV_HRM = nv.ma_nv and nv.thang = 202502
...
insert into ttkd_bsc.ct_bsc_nghiepvu (MA_TB, NGHIEPVU, NGAY_DKY_VI, TEN_LOAIHD, LOAI, USER_CCOS, THANG, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB)
		select SO_SERI, MUCDICH_SD, to_date(NGAY_SUDUNG,'dd/mm/yyyy') NGAY_SUDUNG, 'VINAGIFT' TEN_LOAIHD, 'VINAGIFT' loai, MANV_CN
						, nv.thang, nv.donvi, nv.ma_nv, nv.ten_nv, nv.ten_to, nv.ten_pb, nv.ten_vtcv, nv.ma_vtcv, nv.ma_to, nv.ma_pb
		from tuyenngo.SBH_vinagift_202502_CT a
						join ttkd_bsc.nhanvien nv on nv.donvi = 'TTKD' and  a.MANV_HRM = nv.ma_nv and nv.thang = 202502
;
commit ;
...
-- Theo MA_KN  */
--select * from NV_KHIEUNAI_202502_CT ;
-- drop table ttkd_bsc.x_temp_kn purge ;
	...
	create table ttkd_bsc.x_temp_kn AS 
	 ...
	 where a.ngay_tn between to_date('01/02/2025','dd/mm/yyyy') and to_date('28/02/2025','dd/mm/yyyy')
	 ;
...
-- Theo MA_KN  */
	...
	create table ttkd_bsc.x_temp_gqkn AS 
      ...
      from qltn.v_khieunai@dataguard a
	 where a.ngay_gq between to_date('01/02/2025','dd/mm/yyyy') and to_date('28/02/2025','dd/mm/yyyy')
	 ;
	...
	/* ----PTM-Muc 2--------- ONEBSS - BANTHIETBI ------------ 
		...
		insert into ttkd_bsc.ct_bsc_nghiepvu (ma_tb, ma_kh, NGAY_DKY_VI, TEN_LOAIHD, LOAI, KHACHHANG_ID, thuebao_id, hdkh_id, THANG, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB)
			with tbl as(select a.THANG, ma_tb, MA_KH, TEN_LOAIHD, thuebao_id, KHACHHANG_ID, hdkh_id, MANV_RA_PCT, NGAY_YC
								...
								from tuyenngo.sbh_202502_CT a
												join ttkd_bsc.nhanvien nv on a.nhanvien_id = nv.nhanvien_id and nv.thang = 202502
...
--											, MANV_RA_PCT, TENNV_RA_PCT, MA_VTCV, TEN_VTCV, MATO_RA_PCT, TENTO_RA_PCT, MAPB_RA_PCT, TENPB_RA_PCT
								...
								from tuyenngo.sbh_ct_thu_202502_ct a
		...
		*/
		insert into ttkd_bsc.ct_bsc_nghiepvu (ma_tb, ma_kh, NGAY_DKY_VI, TEN_LOAIHD, LOAI, THANG, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB)
			with tbl as(select nv.thang, ma_tb, MA_KH, TEN_LOAIHD, MANV_RA_PCT, NGAY_CN, USER_CN
											...
											, nv.donvi, nv.ma_nv, nv.ten_nv, nv.ten_to, nv.ten_pb, nv.ten_vtcv, nv.ma_vtcv, nv.ma_to, nv.ma_pb
								from tuyenngo.sbh_vnp_202502_ct a
												join ttkd_bsc.nhanvien nv on a.MANV_RA_PCT = nv.ma_nv and nv.donvi = 'TTKD' and nv.thang = 202502 
		...
		*/
		insert into ttkd_bsc.ct_bsc_nghiepvu (ma_tb, ma_kh, NGAY_DKY_VI, TEN_LOAIHD, LOAI, THANG, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB)
			...
			/* -----HauMai-Muc 7---------- CCBS- DANG KY HUY CHUYEN DOI GOI CUOC ------------ 
				...
				delete from ttkd_bsc.ct_bsc_nghiepvu where ten_loaihd = 'DANG KY HUY CHUYEN DOI GOI CUOC' and thang = 202502;
				*/
		...
		insert into ttkd_bsc.ct_bsc_nghiepvu (ma_tb, ma_kh, NGAY_DKY_VI, TEN_LOAIHD, LOAI, THANG, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB)
			...
			/* ----HauMai-Muc 6----------- CCBS - DOI SIM ------------ 
				...
				delete from ttkd_bsc.ct_bsc_nghiepvu where ten_loaihd = 'DOI SIM' and thang = 202502;
				*/
			insert into ttkd_bsc.ct_bsc_nghiepvu (ma_tb, ma_kh, DOITUONG_ID, NGAY_DKY_VI, TEN_LOAIHD, LOAI, THANG, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB)
						with tbl as(select nv.thang, ma_tb, MA_KH, DOITUONG_ID, TEN_LOAIHD, MANV_RA_PCT, NGAY_CN, USER_CN
														, row_number() over(partition by ma_tb, a.MANV_RA_PCT order by a.ngay_cn) rnk
...
commit ;
			...
			/* -----HauMai-Muc 11---------- CCBS - DONG MO DV|0 ------------ 
				...
				-- 100 nghiep vu trong ngay/KH
				-- thieu thong tin MA_KH, doi tuong KH de xu ly tren cung 1 KH de loc 100 nghiep vu
				delete from ttkd_bsc.ct_bsc_nghiepvu where ten_loaihd = 'DONG MO DV|0' and thang = 202502;
				*/
			insert into ttkd_bsc.ct_bsc_nghiepvu (ma_tb, ma_kh, doituong_id, NGAY_DKY_VI, TEN_LOAIHD, LOAI, THANG, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, ten_vtcv, MA_VTCV, MA_TO, MA_PB)
				with tbl as(select nv.thang, ma_tb, MA_KH, doituong_id, TEN_LOAIHD, MANV_RA_PCT, NGAY_CN, USER_CN
...
--													, row_number() over(partition by MA_KH, a.MANV_RA_PCT order by a.ngay_cn) rnk
			...
			/* ----HauMai-Muc 12----------- CCBS - DONG MO DV|1 ------------ 
				...
				delete from ttkd_bsc.ct_bsc_nghiepvu where ten_loaihd = 'DONG MO DV|1' and thang = 202502;
				*/
		insert into ttkd_bsc.ct_bsc_nghiepvu (ma_tb, ma_kh, doituong_id, NGAY_DKY_VI, TEN_LOAIHD, LOAI, THANG, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, ten_vtcv, MA_VTCV, MA_TO, MA_PB)
				with tbl as(select nv.thang, ma_tb, MA_KH, doituong_id, TEN_LOAIHD, MANV_RA_PCT, NGAY_CN, USER_CN
												, row_number() over(partition by MA_KH, a.MANV_RA_PCT order by a.ngay_cn) rnk
	...
	commit ;		
			/* -----HauMai-Muc 13---------- CCBS - DONG TRUOC GOI CUOC ------------ 
				...
				-- 100 nghiep vu trong ngay/KH
				-- thieu thông tin MA_KH, doi tuong KH ?? x? lý trên cùng 1 KH de l?c 100 nghi?p v?
				delete from ttkd_bsc.ct_bsc_nghiepvu where ten_loaihd = 'DONG TRUOC GOI CUOC' and thang = 202502;
				*/
			insert into ttkd_bsc.ct_bsc_nghiepvu (ma_tb, ma_kh, doituong_id, NGAY_DKY_VI, TEN_LOAIHD, LOAI, THANG, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, ten_vtcv, MA_VTCV, MA_TO, MA_PB)
						with tbl as(select nv.thang, ma_tb, MA_KH, doituong_id, TEN_LOAIHD, MANV_RA_PCT, NGAY_CN, USER_CN
														, row_number() over(partition by MA_KH, a.MANV_RA_PCT order by a.ngay_cn) rnk
...
commit ;
			...
			delete from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'BAN THIET BI' and 'ONEBSS' = loai and a.thang = 202502
			...
			delete from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'TAO MOI GOI DA DICH VU' and 'ONEBSS' = loai and a.thang = 202502
						and exists (select 1 from ttkd_bsc.ct_bsc_nghiepvu where TEN_LOAIHD = 'LAP DAT MOI' and 'ONEBSS' = loai and thuebao_id = a.thuebao_id and thang = a.thang)
						;
			--lo?i tr? trùng ONEBSS - THUKHAC so v?i ONEBSS - Nghiep v? khac
			delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'THU KHAC' and 'ONEBSS' = loai and a.thang = 202502
			...
			delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'THU CUOC' and 'ONEBSS' = loai and a.thang = 202502
			...
			delete from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'DOI SIM' and 'USSD' = loai and a.thang = 202502
			...
			delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'CNTTTB' and 'CCBS' = loai and a.thang = 202502
						and exists (select * from  tuyenngo.sbh_vnp_202502_ct where ten_loaihd = 'CAP NHAT DB' and ma_tb = a.ma_tb)
			;
			--lo?i tr? trùng ONEBSS - THAYDOIDATCOC voi ONEBSS - NGHIEPVUKHAC
			delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'THAY DOI DAT COC' and 'ONEBSS' = loai and a.thang = 202502
			...
			delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'THAY DOI THONG TIN - GIA HAN DICH VU CNTT' and 'ONEBSS' = loai and a.thang = 202502
			...
			delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'THAY DOI TOC DO INTERNET' and 'ONEBSS' = loai and a.thang = 202502
						and exists (select * from  ttkd_bsc.ct_bsc_nghiepvu
											where ten_loaihd = 'LAP DAT MOI' and 'ONEBSS' = loai and ma_tb = a.ma_tb and thang = a.thang)
			;
			--lo?i tr? trùng ONEBSS - TIEP NHAN KHAO SAT DAT MOI voi ONEBSS - LAPDATMOI
			delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'TIEP NHAN KHAO SAT DAT MOI' and 'ONEBSS' = loai and a.thang = 202502
						and exists (select * from  ttkd_bsc.ct_bsc_nghiepvu
			...
			delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'TIEP NHAN LAP DAT MOI' and 'ONEBSS' = loai and a.thang = 202502
						and exists (select * from  ttkd_bsc.ct_bsc_nghiepvu
											where ten_loaihd = 'LAP DAT MOI' and 'ONEBSS' = loai and ma_kh = a.ma_kh and thang = a.thang)
			;
			...
			delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'DAT COC MOI' and 'ONEBSS' = loai and a.thang = 202502
						and exists (select * from  ttkd_bsc.ct_bsc_nghiepvu
											where ten_loaihd = 'LAP DAT MOI' and 'ONEBSS' = loai and ma_kh = a.ma_kh and thang = a.thang)
			;
			...
			delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'THU CUOC' and loai = 'CCBS' and a.thang = 202502
			...
			delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
					where TEN_LOAIHD = 'THU VUOTNGUONG/TAMTHU CN/THUHO' and 'CCBS' = loai and a.thang = 202502
...
--											and nvl(doituong_id, 1) not in (1, 25) 
											and a.thang = 202502 and a.donvi = 'TTKD'
