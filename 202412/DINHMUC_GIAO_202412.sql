...
-- drop TABLE DINHMUC_GIAO_DTHU_PTM_202412 purge ;
    CREATE TABLE "TUYENNGO"."DINHMUC_GIAO_DTHU_PTM_202412" 
   (	"THANG" NUMBER, 
...
truncate table tuyenngo.dinhmuc_giao_dthu_ptm_202412 ;

insert into tuyenngo.dinhmuc_giao_dthu_ptm_202412 (THANG, MA_NV, TEN_NV, MA_TO, TEN_TO, TEN_VTCV, MA_VTCV, MA_PB, TEN_PB, tinh_bsc, THAYDOI_VTCV)
...
/* --------- UP LOAI_KPI ----------- */
update tuyenngo.dinhmuc_giao_dthu_ptm_202412 a set loai_kpi
...
;
commit ;
SELECT DISTINCT MA_VTCV, TEN_VTCV, LOAI_KPI FROM tuyenngo.dinhmuc_giao_dthu_ptm_202412 ;

/* -------- UP TT_MANV ---------- */
update tuyenngo.dinhmuc_giao_dthu_ptm_202412 a set tt_manv=(select ma_nv from
                                                        ( select distinct ma_nv, ma_to, ten_to, thang
                                                            from tuyenngo.dinhmuc_giao_dthu_ptm_202412 
 ...
 =(
    ...
    (
        ...
        from (select * from TTKDHCM_KTNV.ID430_DANGKY_CHOTTHANG 
                where thang = 202412
                and to_char(dateinput,'yyyymm') = 202501) a
        order by 1,2,3
    ) 
...
update tuyenngo.dinhmuc_giao_dthu_ptm_202412 a set (dinhmuc_1, dinhmuc_2, dinhmuc_3)
                                                = (select dinhmuc_1, dinhmuc_2, dinhmuc_3
                                                    from ttkd_bsc.BLDG_DANHMUC_VTCV_P1 b
                                                    where B.thang = a.thang and b.ma_vtcv = a.ma_vtcv)
--		select distinct ma_vtcv, DINHMUC_1, DINHMUC_2, DINHMUC_3 from tuyenngo.dinhmuc_giao_dthu_ptm_202412 a                                              
where a.thang = 202412 
...
select distinct ma_vtcv, ten_vtcv from tuyenngo.dinhmuc_giao_dthu_ptm_202412
where ma_vtcv in ('VNP-HNHCM_BHKV_42', 'VNP-HNHCM_BHKV_51', 'VNP-HNHCM_BHKV_52') ;
/* -------- SUM DINHMUC VAO KPI_CHT_GDV ------------ */
update tuyenngo.dinhmuc_giao_dthu_ptm_202412 a set dinhmuc_1 = '' , dinhmuc_2 = '', dinhmuc_3 = ''
where thang = 202412 and loai_kpi in('KPI_CHT_GDV') and ma_vtcv in ('VNP-HNHCM_BHKV_27') 
;
update tuyenngo.dinhmuc_giao_dthu_ptm_202412 a set (dinhmuc_1,dinhmuc_2,dinhmuc_3)
                        =( select dinhmuc_1,dinhmuc_2,dinhmuc_3
                         ...
                         --              select * 
                                       from tuyenngo.dinhmuc_giao_dthu_ptm_202412 b
                                       where  ma_vtcv in ('VNP-HNHCM_BHKV_22') -- 'VNP-HNHCM_BHKV_27'
                                         and thang = 202412 
                                         and exists(select 1 from ttkd_bsc.nhanvien where thang = 202412 
                                                        and tinh_bsc = 1 and donvi = 'TTKD' and ma_nv=b.ma_nv ) 
                                         and dinhmuc_1 is not null
                                         and exists(select 1 from tuyenngo.dinhmuc_giao_dthu_ptm_202412
...
update tuyenngo.dinhmuc_giao_dthu_ptm_202412 a set  dinhmuc_1 = nvl(dinhmuc_1,0) + 6000000 
                                                   ,dinhmuc_2 = nvl(dinhmuc_2,0) + 5000000
                                                   ,dinhmuc_3 = nvl(dinhmuc_3,0) + 4000000
--select * from tuyenngo.dinhmuc_giao_dthu_ptm_202412
where thang = 202412 and loai_kpi in('KPI_CHT_GDV') 
...
where thang = 202412 and loai_kpi in('KPI_TT','KPI_CHT') 
and ma_vtcv in ('VNP-HNHCM_BHKV_42', 'VNP-HNHCM_BHKV_51', 'VNP-HNHCM_BHKV_52') ;
;
commit ;
...
commit ;
update tuyenngo.dinhmuc_giao_dthu_ptm_202412 a set KHDK = '' ;
update tuyenngo.dinhmuc_giao_dthu_ptm_202412 a set KHDK = CANHAN_GIAO
-- select * from tuyenngo.dinhmuc_giao_dthu_ptm_202412 a
where thang = 202412 and NVL(CANHAN_GIAO,0) > 0 and nvl(KHDK,0) = 0 ;
commit ;

/* ------------ UP LAI KHDK = 0 KHI TONG_DTGIAO is null and dinhmuc_1 is not null ----------- */
update tuyenngo.dinhmuc_giao_dthu_ptm_202412 a set KHDK = TONG_DTGIAO
-- select * from tuyenngo.dinhmuc_giao_dthu_ptm_202412 
where thang = 202412 and TONG_DTGIAO > 0 and nvl(KHDK,0) = 0; -- and dinhmuc_1 is not null 
commit ;

update tuyenngo.dinhmuc_giao_dthu_ptm_202412 a set KHDK = 0
-- select * from tuyenngo.dinhmuc_giao_dthu_ptm_202412 
...
;
commit ;
update tuyenngo.dinhmuc_giao_dthu_ptm_202412 a set (BRCD_DTGIAO, MYTV_DTGIAO, VNPTT_DTGIAO, VNPTS_DTGIAO, TSL_DTGIAO, ITT_DTGIAO
                                    ...
                                    = (select BRCD_DTGIAO, MYTV_DTGIAO, VNPTT_DTGIAO, VNPTS_DTGIAO, TSL_DTGIAO, ITT_DTGIAO
                                          , CNTT_DTGIAO, NHOMBRCD_DTGIAO, NHOMVINA_DTGIAO, NHOMTSL_DTGIAO, NHOMCNTT_DTGIAO, TONG_DTGIAO
                                        from ttkd_bsc.DINHMUC_GIAO_DTHU_PGDPT where thang = 202412 and ma_nv = a.ma_nv)
-- select a.* from tuyenngo.dinhmuc_giao_dthu_ptm_202412 a
where thang = 202412 
and exists(select 1 from ttkd_bsc.DINHMUC_GIAO_DTHU_PGDPT where ma_nv = a.ma_nv and thang = 202412)
;
commit ;
/* ----------- IMP VAO FILE CHINH --------- */
...
;
commit ;
select * from ttkd_bsc.dinhmuc_giao_dthu_ptm where thang = 202412 ;
